...
- **Auto-mula giliran** — dinilai **sekali** selepas bind loopback berjaya
  ...
  `sedang_dihantar` (yatim selepas crash/restart) untuk tarikh **hari ini**
  ...
  tulis, konflik => berhenti (perlu penyesuaian manusia). Tiada cubaan semula
  automatik untuk `gagal`/`tersimpan`/`berjaya`; satu tugasan sekali sepanjang
  hayat proses; kelayakan diperiksa semula sebelum klaim dan sebelum mutasi
  MOEIS; mematikan suis menghentikan giliran auto tanpa hidup semula dalam
  proses sama.
