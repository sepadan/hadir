...
const CACHE_VERSION = 'hadir-shell-v1.11.38-20260925-1';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.11.38', './config.js?v=1.11.38',
  './app.js?v=1.11.38', './manifest.webmanifest?v=1.11.38', './offline.html',
