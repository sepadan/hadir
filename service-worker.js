...
const CACHE_VERSION = 'hadir-shell-v1.6.3-20260826-3';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.6.3', './config.js?v=1.6.3',
  './app.js?v=1.6.3', './manifest.webmanifest?v=1.6.3', './offline.html',
