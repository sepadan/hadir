...
const CACHE_VERSION = 'hadir-shell-v1.10.0-20260917-1';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.10.0', './config.js?v=1.10.0',
  './app.js?v=1.10.0', './manifest.webmanifest?v=1.10.0', './offline.html',
