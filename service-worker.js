const CACHE_VERSION = 'hadir-shell-v1.0.0-20260824-1';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.0.0', './config.js?v=1.0.0',
  './app.js?v=1.0.0', './manifest.webmanifest?v=1.0.0', './offline.html',
