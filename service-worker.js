...
const CACHE_VERSION = 'hadir-shell-v1.8.0-20260828-2';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.8.0', './config.js?v=1.8.0',
  './app.js?v=1.8.0', './manifest.webmanifest?v=1.8.0', './offline.html',
