...
const CACHE_VERSION = 'hadir-shell-v1.11.0-20260918-1';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.11.0', './config.js?v=1.11.0',
  './app.js?v=1.11.0', './manifest.webmanifest?v=1.11.0', './offline.html',
