...
const CACHE_VERSION = 'hadir-shell-v1.9.0-20260828-5';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.9.0', './config.js?v=1.9.0',
  './app.js?v=1.9.0', './manifest.webmanifest?v=1.9.0', './offline.html',
