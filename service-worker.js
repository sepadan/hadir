...
const CACHE_VERSION = 'hadir-shell-v1.6.0-20260826-1';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.6.0', './config.js?v=1.6.0',
  './app.js?v=1.6.0', './manifest.webmanifest?v=1.6.0', './offline.html',
