...
const CACHE_VERSION = 'hadir-shell-v1.7.0-20260828-1';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.7.0', './config.js?v=1.7.0',
  './app.js?v=1.7.0', './manifest.webmanifest?v=1.7.0', './offline.html',
