...
const CACHE_VERSION = 'hadir-shell-v1.11.39-20260925-1';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.11.39', './config.js?v=1.11.39',
  './app.js?v=1.11.39', './manifest.webmanifest?v=1.11.39', './offline.html',
