...
const CACHE_VERSION = 'hadir-shell-v1.3.1-20260825-1';
const APP_SHELL = [
  './', './index.html', './styles.css?v=1.3.1', './config.js?v=1.3.1',
  './app.js?v=1.3.1', './manifest.webmanifest?v=1.3.1', './offline.html',
